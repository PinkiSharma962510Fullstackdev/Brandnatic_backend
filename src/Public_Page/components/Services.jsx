...
//   {
//     title: "Social Media Optimization",
//     desc: "AI-driven social media optimization to build brand trust and attract qualified real-estate buyers.",
//     image: "/services_img/seo-smo.webp",
//   },
//   {
//     title: "Lead Generation",
//     desc: "High-quality AI-powered lead generation systems focused on conversions, not vanity metrics.",
//     image: "/services_img/lead-generation.webp",
//   },
//   {
//     title: "Automation",
//     desc: "Smart automation workflows ensuring instant responses, follow-ups, and higher booking rates.",
//     image: "/services_img/automation.webp",
//   },
//   {
//     title: "SEO",
//     desc: "Long-term, data-driven SEO strategies that bring high-intent organic traffic consistently.",
//     image: "/services_img/ai-Marketing.webp", // best SEO/AI visual fit
//   },
//   {
//     title: "E-Commerce Solutions",
//     desc: "AI-based e-commerce solutions to boost conversions and predictable online growth.",
//     image: "/services_img/ecommerce-solution.webp",
//   },
//   {
//     title: "Paid Ads & Growth Campaigns",
//     desc: "AI-optimized paid campaigns delivering serious buyers and measurable ROI.",
//     image: "/services_img/paid-ads.webp",
//   },
//   {
//     title: "Marketing Automation",
//     desc: "End-to-end marketing automation to nurture leads and increase conversion velocity.",
//     image: "/services_img/automation.webp",
//   },
//   {
//     title: "Custom Web Development",
//     desc: "Conversion-focused, fast, and scalable websites built for real-estate growth.",
...
//       if (track.scrollLeft + cardWidth + gap >= maxScroll) {
...
//   return (
//     <section className="bg-gradient-to-b from-[#0a0e17] via-[#05080f] to-[#0a0e17] py-24">
...
//           <button
//             onClick={() => scroll("left")}
//             className="absolute left-0 z-30 w-12 h-12 rounded-full bg-black/60 border border-white/20 text-white flex items-center justify-center hover:bg-[#1AA9F2]/80 transition"
//           >
//             <ChevronLeft size={24} />
//           </button>
...
//             {/* TRACK (SCROLLABLE BUT HIDDEN UI) */}
//             <div
//               ref={trackRef}
...
//   absolute inset-0
//   bg-gradient-to-t
//   from-black/90 via-black/55 to-black/20
...
//                   {/* CONTENT */}
//                   <div className="
//   relative z-10 flex items-center justify-center h-full p-6 text-center
// ">
...
//                   {/* GLOW */}
//                   <div className="absolute inset-0 rounded-3xl ring-1 ring-white/10 group-hover:ring-[#1AA9F2]/50 transition pointer-events-none" />
//                 </motion.div>
//               ))}
//             </div>
//           </div>
...
//             className="absolute right-0 z-30 w-12 h-12 rounded-full bg-black/60 border border-white/20 text-white flex items-center justify-center hover:bg-[#1AA9F2]/80 transition"
//           >
    ...
    <section className="bg-gradient-to-b from-[#0a0e17] via-[#05080f] to-[#0a0e17] py-24">
      <div className="max-w-7xl mx-auto px-5">
        ...
        >
          ...
          <p className="mt-6 text-gray-300 max-w-4xl mx-auto text-base md:text-lg leading-relaxed">Brandnatic's AI-powered services are created just for real estate developers and brokers who want a consistent supply of high-quality property leads. We use AI-driven ads, smart targeting, and automated follow-ups to get serious buyers, not people who just want to waste our time. Our systems are made to turn interest into visits to your site, bookings, and sales. In this manner, your marketing works like a reliable lead and sales engine instead of an experiment.</p>
        </motion.div>
            ...
            >
              {services.map((service, i) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center justify-center h-full p-6 text-center">
                    ...
                    >
                      <h3 className="
                        ...
                        tracking-wide
                        drop-shadow-[0_0_14px_rgba(26,169,242,0.35)]
                      ">
                        {service.title}
                      </h3>
                    </div>
                  ...
                  <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 shadow-[0_0_80px_rgba(26,169,242,0.35)] pointer-events-none" />
                </motion.div>
              ))}
            </div>
          </div>
